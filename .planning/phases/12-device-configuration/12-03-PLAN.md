...
This allows explicit override for testing or when caller knows better.
  ...
  <verify>
Run: python -c "from scholardoc_ocr import surya; models, device = surya.load_models(); print(f'Loaded on: {device}')"

Note: This loads actual models and takes 30-60 seconds. Verify log output shows "Using device: ..."
  </verify>
  <done>
